      ...
      <main className="flex-1 p-4 sm:p-6 lg:p-10 w-full overflow-y-auto">
        ...
        <div className="mb-10">
          <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-6">
            <div>
              <h1 className="text-3xl lg:text-4xl font-extrabold text-slate-900 mb-3 tracking-tight">Welcome back, Student! 👋</h1>
              <div className="inline-flex items-center gap-2 bg-white px-4 py-2.5 rounded-xl border border-slate-200 shadow-sm">
                <Target className="w-5 h-5 text-emerald-600" />
                <span className="text-sm font-bold text-slate-700">Current Track: <span className="text-emerald-600">Full Stack Development</span></span>
              </div>
            </div>
        ...
        <div className="grid grid-cols-1 xl:grid-cols-2 gap-8 mb-12">
          ...
          <div className="bg-white rounded-3xl p-6 lg:p-8 shadow-sm hover:shadow-md border border-slate-100 relative overflow-hidden group transition-all duration-300">
            ...
            <h3 className="text-xl font-extrabold text-slate-900 mb-1 z-10 relative">Roadmap Progress</h3>
            ...
            <div className="flex items-end justify-between mb-3 z-10 relative">
              <span className="text-5xl font-black text-slate-900 tracking-tighter">45<span className="text-2xl text-slate-400">%</span></span>
              <span className="text-sm font-bold text-slate-400 uppercase tracking-widest">12/28 Modules</span>
            </div>
            
            <div className="w-full bg-slate-100 rounded-full h-3 mb-2 z-10 relative shadow-inner overflow-hidden">
              <div className="bg-emerald-500 h-3 rounded-full relative transition-all duration-1000 ease-out" style={{ width: '45%' }}></div>
            </div>
          </div>

          {/* Coding Stats Widget */}
          <div className="bg-white rounded-3xl p-6 lg:p-8 shadow-sm hover:shadow-md border border-slate-100 transition-all duration-300">
            ...
            <h3 className="text-xl font-extrabold text-slate-900 mb-8">Coding Stats</h3>
        ...
        <div className="grid grid-cols-1 xl:grid-cols-2 gap-6">
          {/* Next Topic Card */}
          <div className="bg-white rounded-3xl p-6 shadow-sm border border-slate-100 flex gap-5 items-center group cursor-pointer hover:shadow-md hover:border-emerald-200 transition-all">
            ...
            <div className="flex-1">
              ...
              <h4 className="text-lg font-bold text-slate-900 mb-1 leading-tight group-hover:text-emerald-700 transition-colors">Advanced React Hooks</h4>
          ...
          {/* Last coding problem */}
          <div className="bg-white rounded-3xl p-6 shadow-sm border border-slate-100 flex gap-5 items-center hover:shadow-md cursor-pointer hover:border-slate-300 transition-all group">
            ...
            <div className="flex-1">
              ...
              <h4 className="text-lg font-bold text-slate-900 mb-1 leading-tight">Two Sum</h4>
