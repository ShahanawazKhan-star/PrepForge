      ...
      >
        <div className="text-center mb-8">
          ...
          <p className="mt-2 text-sm text-slate-600">
            Join PrepForge to start your tech journey
          </p>
        </div>
        ...
        <div className="bg-white rounded-2xl shadow-sm border border-slate-200 p-8 z-base">
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <button
              type="submit"
              disabled={isLoading}
              className="w-full flex justify-center items-center gap-2 py-3 px-4 rounded-xl shadow-[0_4px_14px_0_rgba(22,163,74,0.39)] text-sm font-bold text-white bg-green-600 hover:bg-green-700 hover:shadow-[0_6px_20px_rgba(22,163,74,0.23)] focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500 transition-all disabled:opacity-70 disabled:cursor-not-allowed group mt-2"
            >
              {isLoading ? (
