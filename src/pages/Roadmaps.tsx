...
export default function Roadmaps() {
  ...
  return (
    <div className="min-h-screen bg-slate-950 text-slate-200 font-sans selection:bg-emerald-500/30 flex flex-col">
      {/* Header */}
      <div className="bg-slate-900/80 backdrop-blur-md border-b border-slate-800 sticky top-0 z-50 shadow-sm">
        <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
          <div className="flex items-center gap-4">
            ...
            <div className="flex items-center gap-2">
              ...
              <h1 className="text-xl font-bold tracking-tight text-white">Career Pathways</h1>
            </div>
          </div>
        </div>
      </div>
          ...
          {milestones.map((milestone, index) => {
            ...
            return (
              ...
              >
                ...
                <div className="md:hidden absolute -left-[41px] top-8 w-4 h-4 rounded-full bg-slate-950 border-2 border-emerald-500 shadow-[0_0_15px_rgba(16,185,129,0.8)] z-10"></div>
                
                {/* Desktop center icon */}
                <div className="hidden md:flex absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 w-14 h-14 rounded-full bg-slate-900 border border-emerald-500/50 shadow-[0_0_20px_rgba(16,185,129,0.3)] items-center justify-center z-10 text-emerald-400 group-hover:scale-110 transition-transform duration-300">
                ...
                <div className="w-full md:w-[45%]">
                  <div className="bg-slate-900 overflow-hidden border border-slate-800 p-8 rounded-3xl hover:border-emerald-500/50 transition-all duration-300 hover:shadow-[0_0_40px_-10px_rgba(16,185,129,0.2)] group relative">
                    ...
                    <div className="relative z-10">
                      ...
                      <p className="text-slate-400 mb-8 leading-relaxed text-md md:text-lg">
                        {milestone.description}
                      </p>
                      
                      <div className="flex flex-wrap gap-2">
                        {milestone.tech.map(t => (
                          <span key={t} className="px-3 py-1.5 bg-slate-950 border border-slate-800 rounded-lg text-sm text-slate-300 font-medium tracking-wide">
                            {t}
                          </span>
                        ))}
                      </div>
      ...
      <div className="border-t border-slate-800/50 bg-slate-950 mt-auto">
